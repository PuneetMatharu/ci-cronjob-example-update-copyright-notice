...
//======================================================================
/// \short A version of the GeneralisedAdvection Diffusion equations that can be
 ...
 public virtual RefineableQElement<DIM>
{
 ...
 unsigned nvertex_node() const
  {return 
    QGeneralisedAdvectionDiffusionElement<DIM,NNODE_1D>::nvertex_node();}

 /// \short Pointer to the j-th vertex node in the element
 Node* vertex_node_pt(const unsigned& j) const
  {return 
    QGeneralisedAdvectionDiffusionElement<DIM,NNODE_1D>::vertex_node_pt(j);}
