...
public:
 ...
 Source_fct_pt(0), Wind_fct_pt(0),
  Conserved_wind_fct_pt(0), Diff_fct_pt(0), ALE_is_disabled(false)
  {
...
//quite rightly, it shouts.
 ...
 virtual inline unsigned u_index_cons_axisym_adv_diff() const {return 0;}
...
/// \short du/dt at local node n. 
 ...
 /// another system of equations 
 inline virtual void get_wind_cons_axisym_adv_diff(const unsigned& ipt,
                                                   ...
                                                   Vector<double>& wind) const
 {
  ...
  if(Wind_fct_pt==0)
   {
    for(unsigned i=0;i<3;i++) {wind[i]= 0.0;}
   }
  else
   {
    // Get wind
 ...
 /// the wind function might be determined by
 /// another system of equations 
 inline virtual void get_diff_cons_axisym_adv_diff(const unsigned& ipt,
                                                   const Vector<double> &s,
                                                   const Vector<double>& x,
     ...
     for(unsigned i=0;i<3;i++) 
      {
       for(unsigned j=0;j<3;j++)
        {
         if(i==j) {D(i,j) = 1.0;} else {D(i,j) = 0.0;}
        }
      }
    }
   else
 ...
 void fill_in_contribution_to_jacobian_and_mass_matrix(
  ...
  DenseMatrix<double> &mass_matrix)
  {
   ...
   fill_in_generic_residual_contribution_cons_axisym_adv_diff(residuals,
...
private:
 ...
 QGeneralisedAxisymAdvectionDiffusionElement() : QElement<2,NNODE_1D>(), 
  GeneralisedAxisymAdvectionDiffusionEquations()
  { }
...
//=======================================================================
/// \short Face geometry for the QGeneralisedAxisymAdvectionDiffusionElement elements: 
