...
template <unsigned DIM, unsigned NNODE_1D>
 class QSpectralPoissonElement : public virtual QSpectralElement<DIM,NNODE_1D>,
 public virtual PoissonEquations<DIM>
{
 ...
 /// Poisson equations
 QSpectralPoissonElement() : QSpectralElement<DIM,NNODE_1D>(), 
...
//quite rightly, it shouts.
 /*void operator=(const QSpectralPoissonElement<DIM,NNODE_1D>&) 
  {
   BrokenCopy::broken_assign("QSpectralPoissonElement");
   }*/
