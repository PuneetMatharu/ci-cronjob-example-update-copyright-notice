...
RefineableGeneralisedNewtonianQTaylorHoodElement<DIM> > >: 
public virtual FaceGeometry<FaceGeometry<
GeneralisedNewtonianQTaylorHoodElement<DIM> > >
{
  public:
 FaceGeometry() : FaceGeometry<FaceGeometry<
  GeneralisedNewtonianQTaylorHoodElement<DIM> > >() 
  {}
};
...
//quite rightly, it shouts.
 ...
 Node* vertex_node_pt(const unsigned& j) const
  {
   return GeneralisedNewtonianQCrouzeixRaviartElement<DIM>::vertex_node_pt(j);
  }
...
class FaceGeometry<
RefineableGeneralisedNewtonianQCrouzeixRaviartElement<DIM> >: 
public virtual FaceGeometry<GeneralisedNewtonianQCrouzeixRaviartElement<DIM> >
{
  public:
...
//=====================================================================
template<>
inline void RefineableGeneralisedNewtonianQCrouzeixRaviartElement<2>::
...
//=================================================================
template<>
inline void RefineableGeneralisedNewtonianQCrouzeixRaviartElement<3>::
rebuild_from_sons(Mesh* &mesh_pt)
{
...
//=======================================================================
template<>
inline double PRefineableGeneralisedNewtonianQCrouzeixRaviartElement<2>::
...
//=======================================================================
template<>
inline double PRefineableGeneralisedNewtonianQCrouzeixRaviartElement<3>::
dshape_and_dtest_eulerian_nst(const Vector<double> &s, Shape &psi, 
                              DShape &dpsidx, Shape &test, 
                              DShape &dtestdx) const
{
...
//=======================================================================
template<>
inline void PRefineableGeneralisedNewtonianQCrouzeixRaviartElement<2>::
...
//=======================================================================
template<>
inline void PRefineableGeneralisedNewtonianQCrouzeixRaviartElement<3>::
pshape_nst(const Vector<double> &s, Shape &psi) const
{
 unsigned npres = this->npres_nst();
 if (npres==1)
