...
#define OOMPH_MIXED_ORDER_PETROV_GALERKIN_SPACE_TIME_NAVIER_STOKES_ELEMENTS_HEADER
...
namespace oomph
{
 // DRAIG: Can I just delete this stuff?
 //======================================================================
 ...
 //======================================================================
 class FpPressureAdvDiffRobinBCMixedOrderSpaceTimeElementBase : public virtual FaceElement
 {
 public:
 ...
 class FpPressureAdvDiffRobinBCMixedOrderSpaceTimeElement :
  ...
  public virtual FpPressureAdvDiffRobinBCMixedOrderSpaceTimeElementBase 
 { 
 public:
...
#endif   
  } // End of FpPressureAdvDiffRobinBCMixedOrderSpaceTimeElement
 ...
 //============================================================================
 template<class ELEMENT>
 void FpPressureAdvDiffRobinBCMixedOrderSpaceTimeElement<ELEMENT>::
 ...
 class SpaceTimeNavierStokesMixedOrderEquations
  : public virtual FSIFluidElement,
    public virtual TemplateFreeSpaceTimeNavierStokesMixedOrderEquationsBase
 {
 public:

  /// \short Function pointer to body force function fct(t,x,f(x))
  /// x is a Vector!
  typedef void (*NavierStokesMixedOrderBodyForceFctPt)(const double& time,
					     const Vector<double>& x,
					     Vector<double>& body_force);

  /// \short Function pointer to source function fct(t,x) (x is a Vector!)
  typedef double (*NavierStokesMixedOrderSourceFctPt)(const double& time,
					    const Vector<double>& x);
  ...
  typedef double (*NavierStokesMixedOrderPressureAdvDiffSourceFctPt)
  (const Vector<double>& x);
 ...
 protected:
  ...
  Vector<FpPressureAdvDiffRobinBCMixedOrderSpaceTimeElementBase*>
  ...
  /// DRAIG: Fill in later...
  virtual void shape_u_nst(const Vector<double>& s, 
			  Shape& psi) const=0;
  

  /// DRAIG: Fill in later...
  virtual void dshape_local_u_nst(const Vector<double>& s, 
				  Shape& psi, 
				  DShape& dpsidx) const=0;
  

  /// DRAIG: Fill in later...
  virtual void dtest_local_u_nst(const Vector<double>& s, 
				 Shape& test, 
				 DShape& dtestdx) const=0;
 ...
 public:
  ...
  SpaceTimeNavierStokesMixedOrderEquations() : Body_force_fct_pt(0),
					       Source_fct_pt(0),
  ...
  void store_reynolds_strouhal_as_external_data(Data* reynolds_strouhal_data_pt)
  {
   ...
   if (reynolds_strouhal_data_pt==0)
   {
    // Create an output stream
    std::ostringstream error_message_stream;

    // Create an error message
    error_message_stream << "User supplied the Reynolds x Strouhal number as "
   ...
   this->add_external_data(reynolds_strouhal_data_pt);
  ...
  NavierStokesMixedOrderSourceFctPt& source_fct_pt() {return Source_fct_pt;}

  ///Access function for the source-function pointer. Const version
  NavierStokesMixedOrderSourceFctPt source_fct_pt() const {return Source_fct_pt;}
				       ...
				       const unsigned& i) const
  {
   ...
   dshape_local_u_nst(s,psi,dpsidx);
  ...
  /// \short Write values of the i_field-th scalar field at the plot points.
  /// Needs to be implemented for each new specific element type.
 ...
 protected:
  ...
  /// DRAIG: Fill in later...
  inline void dshape_local_u_nst(const Vector<double>& s, 
				 Shape& psi, 
				 DShape& dpsidx) const;
  

  /// DRAIG: Fill in later...
  inline void dtest_local_u_nst(const Vector<double>& s, 
				Shape& test, 
				DShape& dtestdx) const;
 ...
 public:
  ...
  /// \short Helper function which deduce the pressure node index associated
  /// with elemental node n (we're assuming there's a pressure dof stored
  /// at this node!)
  int element_node_index_to_pressure_node_index(const unsigned& n)
  {
   ...
   const unsigned* it=std::find(this->Pconv,this->Pconv+n_p,n);

   // If we managed to find the value
   if (it!=this->Pconv+n_p)
   {
    // Return the pressure node index associated with n
    return (it-(this->Pconv));
   }
   else
   {
  ...
  } // End of element_node_index_to_pressure_node_index
  ...
  /// DRAIG: Fill in later...
  inline void shape_u_nst(const Vector<double>& s, 
			  Shape& psi) const;
  ...
  void build_fp_press_adv_diff_robin_bc_element(const unsigned& face_index)
  {
   ...
   this->Pressure_advection_diffusion_robin_element_pt.push_back(
    new FpPressureAdvDiffRobinBCMixedOrderSpaceTimeElement<
    QTaylorHoodMixedOrderSpaceTimeElement<DIM> >(this,face_index));
  ...
  void output(std::ostream& outfile) 
  {
   ...
   SpaceTimeNavierStokesMixedOrderEquations<DIM>::output(outfile);
  } // End of output
  ...
  {
   // Call the base class implementation
   SpaceTimeNavierStokesMixedOrderEquations<DIM>::output(outfile,nplot);
  } // End of output
  ...
  {
   // Call the base class implementation
   SpaceTimeNavierStokesMixedOrderEquations<DIM>::output(file_pt);
  } // End of output
  ...
  {
   // Call the base class implementation
   SpaceTimeNavierStokesMixedOrderEquations<DIM>::output(file_pt,nplot);
  } // End of output
 ...
 //==========================================================================
 template<>
 inline void QTaylorHoodMixedOrderSpaceTimeElement<2>::
 shape_u_nst(const Vector<double>& s,Shape& psi) const
 {
  // Number of dimensions (3D = 2D space + 1D time)
  unsigned n_dim=3;

  // Number of nodes in each direction
  unsigned n_node_1d=3;
  
  // Local storage for the shape function value (3D, NNODE_1D=3)
  double psi_values[n_dim][n_node_1d];
  
  // Call the OneDimensional Shape functions
  OneDimLagrange::shape<3>(s[0],psi_values[0]);
  OneDimLagrange::shape<3>(s[1],psi_values[1]);
  
  // Call the OneDimensional Shape functions
  OneDimDiscontinuousGalerkinMixedOrderBasis::shape<3>(s[2],psi_values[2]);

  // Index of the total shape function
  unsigned index=0;
  
  // Loop over the points in the z-direction
  for (unsigned i=0;i<n_node_1d;i++)
  {
   // Loop over the points in the y-direction
   for (unsigned j=0;j<n_node_1d;j++)
   {
    // Loop over the points in the x-direction
    for (unsigned k=0;k<n_node_1d;k++)
    {
     // Calculate the index-th entry of psi
     psi[index]=psi_values[0][k]*psi_values[1][j]*psi_values[2][i];
 ...
 template<>
 inline void QTaylorHoodMixedOrderSpaceTimeElement<2>::
 dshape_local_u_nst(const Vector<double>& s,
		    Shape& psi, 
		    DShape& dpsidx) const
 {
  // Number of dimensions (3D = 2D space + 1D time)
  ...
  // Local storage for the shape function value 
  double psi_values[n_dim][n_node_1d];
  double dpsi_values[n_dim][n_node_1d];
  
  // Call the OneDimensional Shape functions
  OneDimLagrange::shape<3>(s[0],psi_values[0]);
  OneDimLagrange::shape<3>(s[1],psi_values[1]);
  OneDimLagrange::dshape<3>(s[0],dpsi_values[0]);
  OneDimLagrange::dshape<3>(s[1],dpsi_values[1]);
  
  // Call the OneDimensional Shape functions
  OneDimDiscontinuousGalerkinMixedOrderBasis::shape<3>(s[2],psi_values[2]);
  OneDimDiscontinuousGalerkinMixedOrderBasis::dshape<3>(s[2],dpsi_values[2]);
  ...
  for (unsigned i=0;i<n_node_1d;i++)
  {
   ...
   for (unsigned j=0;j<n_node_1d;j++)
   {
    ...
    {
     // Calculate dpsi/ds_0
     dpsidx(index,0)=dpsi_values[0][k]*psi_values[1][j]*psi_values[2][i];
     
     // Calculate dpsi/ds_1
     dpsidx(index,1)=psi_values[0][k]*dpsi_values[1][j]*psi_values[2][i];
     
     // Calculate dpsi/ds_2
     dpsidx(index,2)=psi_values[0][k]*psi_values[1][j]*dpsi_values[2][i];
 ...
 template<>
 inline void QTaylorHoodMixedOrderSpaceTimeElement<2>::
 dtest_local_u_nst(const Vector<double>& s,
		   Shape& test, 
		   DShape& dtestdx) const
 {
  // Number of dimensions (3D = 2D space + 1D time)
  ...
  // Local storage for the shape function value 
  double test_values[n_dim][n_node_1d];
  double dtest_values[n_dim][n_node_1d];
  ...
  // Call the OneDimensional Shape functions
  OneDimDiscontinuousGalerkinMixedOrderTest::shape<3>(s[2],test_values[2]);
  OneDimDiscontinuousGalerkinMixedOrderTest::dshape<3>(s[2],dtest_values[2]);
  //OneDimDiscontinuousGalerkinMixedOrderBasis::shape<3>(s[2],test_values[2]);
  //OneDimDiscontinuousGalerkinMixedOrderBasis::dshape<3>(s[2],dtest_values[2]);
  ...
  for (unsigned i=0;i<n_node_1d;i++)
  {
   ...
   for (unsigned j=0;j<n_node_1d;j++)
   {
    ...
    for (unsigned k=0;k<n_node_1d;k++)
    {
     ...
     dtestdx(index,0)=dtest_values[0][k]*test_values[1][j]*test_values[2][i];
     
     // Calculate dtest/ds_1
     dtestdx(index,1)=test_values[0][k]*dtest_values[1][j]*test_values[2][i];
     
     // Calculate dtest/ds_2
     dtestdx(index,2)=test_values[0][k]*test_values[1][j]*dtest_values[2][i];
     
     // Calculate the index-th entry of test
     test[index]=test_values[0][k]*test_values[1][j]*test_values[2][i];
 ...
 //==========================================================================
 template<unsigned DIM>
 inline double QTaylorHoodMixedOrderSpaceTimeElement<DIM>::
			       ...
			       DShape& dtestdx) const
 {
  ...
  // w.r.t. local coordinates at local coordinate s
  dtest_local_u_nst(s,test,dtestdx);
 ...
 //==========================================================================
 template<>
 inline double QTaylorHoodMixedOrderSpaceTimeElement<2>::
 ...
 {  
  ...
  // Call the OneDimensional Shape functions
  OneDimDiscontinuousGalerkinMixedOrderBasis::shape<2>(s[2],psi3);
  OneDimDiscontinuousGalerkinMixedOrderBasis::dshape<2>(s[2],dpsi3);
 ...
 {  
  ...
  // Call the OneDimensional Shape functions
  OneDimDiscontinuousGalerkinMixedOrderTest::shape<2>(s[2],test3);

  // DRAIG: Delete...
  //OneDimDiscontinuousGalerkinMixedOrderBasis::shape<2>(s[2],test3);
  ...
  // Call the OneDimensional Shape functions
  OneDimDiscontinuousGalerkinMixedOrderTest::dshape<2>(s[2],dtest3);

  // DRAIG: Delete...
  //OneDimDiscontinuousGalerkinMixedOrderBasis::dshape<2>(s[2],dtest3);
 ...
 template<>
 inline void QTaylorHoodMixedOrderSpaceTimeElement<2>::
 ptest_nst(const Vector<double>& s,Shape& test) const
 {
  // Local storage for the shape function value (in the x-direction)
  double test1[2];
 ...
 //==========================================================================
 template<unsigned DIM>
 inline void QTaylorHoodMixedOrderSpaceTimeElement<DIM>::
