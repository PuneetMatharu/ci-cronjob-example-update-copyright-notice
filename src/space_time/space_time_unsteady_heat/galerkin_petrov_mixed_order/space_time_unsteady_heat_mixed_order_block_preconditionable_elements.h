...
namespace oomph
{
  ...
  class BlockPrecQUnsteadyHeatMixedOrderSpaceTimeElement :
    public virtual QUnsteadyHeatMixedOrderSpaceTimeElement<SPATIAL_DIM,NNODE_1D>,
  ...
  class BlockPrecRefineableQUnsteadyHeatMixedOrderSpaceTimeElement :
    public virtual RefineableQUnsteadyHeatMixedOrderSpaceTimeElement<SPATIAL_DIM,NNODE_1D>,
    public virtual BlockPreconditionableSpaceTimeElementBase
  {
  public:
