       ...
       if(local_eqn>= 0)
        {
         ...
         switch (i)
          ...
          case 0:
           ...
           // stress term 3
           sum -= 
            visc_ratio*viscosity*(1.0 + Gamma[0])*interpolated_u[0]
                       ...
                       if(!Use_extrapolated_strainrate_to_compute_second_invariant)
                        {
                         ...
                         jacobian(local_eqn,local_unknown)
                          ...
                          r*(1.0+Gamma[0])*interpolated_dudx(0,0)*
                       ...
                       if(!Use_extrapolated_strainrate_to_compute_second_invariant)
                        {
                         ...
                         jacobian(local_eqn,local_unknown)
                          -= visc_ratio*dviscosity_dUr[l2]*
                          r*(interpolated_dudx(0,1) + Gamma[0]*
                       ...
                       if(!Use_extrapolated_strainrate_to_compute_second_invariant)
                        {
                         ...
                         jacobian(local_eqn,local_unknown)
                          -= visc_ratio*dviscosity_dUr[l2]*
                          (1.0 + Gamma[0])*interpolated_u[0]*testf[l]*W*
                       ...
                       if(!Use_extrapolated_strainrate_to_compute_second_invariant)
                        {
                         ...
                         jacobian(local_eqn,local_unknown)
                          -= visc_ratio*dviscosity_dUz[l2]*
                          (1.0 + Gamma[0])*interpolated_u[0]*testf[l]*
                       ...
                       if(!Use_extrapolated_strainrate_to_compute_second_invariant)
                        {
                         ...
                         jacobian(local_eqn,local_unknown) -= 
                          visc_ratio*dviscosity_dUr[l2]*
                          r*(interpolated_dudx(1,0) + Gamma[1]*
                       ...
                       if(!Use_extrapolated_strainrate_to_compute_second_invariant)
                        {
                         ...
                         jacobian(local_eqn,local_unknown) -= 
                          visc_ratio*dviscosity_dUr[l2]*
                          r*(1.0 + Gamma[1])*interpolated_dudx(1,1)*
                          dtestfdx(l,1)*W*hang_weight*hang_weight2;
                        }
                    ...
                    case 2:
                     switch (i2)
                       ...
                       if(!Use_extrapolated_strainrate_to_compute_second_invariant)
                        {
                         ...
                         jacobian(local_eqn,local_unknown) -= 
                          visc_ratio*dviscosity_dUr[l2]*
                          r*interpolated_dudx(2,1)*dtestfdx(l,1)*
                          W*hang_weight*hang_weight2;
                         ...
                         jacobian(local_eqn,local_unknown) -= 
                          visc_ratio*dviscosity_dUr[l2]*
                          ((interpolated_u[2]/r) -Gamma[0]*
                           interpolated_dudx(2,0))*
                          testf[l]*W*hang_weight*hang_weight2;
                        }
                      ...
                      case 2:
                       ...
                       // stress term 2
                       jacobian(local_eqn,local_unknown) -= 
                        visc_ratio*viscosity*r*dpsifdx(l2,1)*dtestfdx(l,1)
                        *W*hang_weight*hang_weight2;
 ...
 RankThreeTensor<double>& dresidual_dnodal_coordinates)
{
 ...
 std::string function = "RefineableGeneralisedNewtonianAxisymmetricNavierStokesEquations::\n";
   ...
   if(nod_pt->has_auxiliary_node_update_fct_pt())
    {
     ...
     OomphLibWarning(
      warning_stream.str(),
      "RefineableGeneralisedNewtonianAxisymmetricNavierStokesEquations::get_dresidual_dnodal_coordinates",
      OOMPH_EXCEPTION_LOCATION);
