...
PROTOCCALLSFSUB9(MA42JD,ma42jd,INT,INTV,INT,INTV,INT,INTV,INTV,INTV,INTV)
...
PROTOCCALLSFSUB22(MA42BD,ma42bd,INT,INTV,INT,INTV,INT,DOUBLEVV,INT,DOUBLEVV,INT,INT,DOUBLEVV,INTV,INTV,INT,DOUBLEV,INT,INTV,INTV,DOUBLEV,INTV,INTV,DOUBLEV)
#define MA42BD(NVAR,IVAR,NDF,LAST,NMAXE,AVAR,NRHS,RHS,LRHS,LX,X,NFRONT,LENBUF,LW,W,LIW,IW,ICNTL,CNTL,ISAVE,INFO,RINFO) CCALLSFSUB22(MA42BD,ma42bd,INT,INTV,INT,INTV,INT,DOUBLEVV,INT,DOUBLEVV,INT,INT,DOUBLEVV,INTV,INTV,INT,DOUBLEV,INT,INTV,INTV,DOUBLEV,INTV,INTV,DOUBLEV,NVAR,IVAR,NDF,LAST,NMAXE,AVAR,NRHS,RHS,LRHS,LX,X,NFRONT,LENBUF,LW,W,LIW,IW,ICNTL,CNTL,ISAVE,INFO,RINFO)
 ...
 PROTOCCALLSFSUB12(MA42CD,ma42cd,LOGICAL,INT,INT,DOUBLEVV,DOUBLEVV,INT,DOUBLEV,INT,INTV,INTV,INTV,INTV)
...
PROTOCCALLSFSUB19(MC63AD,mc63ad,LOGICAL,INT,INT,INT,INTV,INTV,INTV,INTV,PINT,INTV,INTV,DOUBLEV,INT,INTV,INT,DOUBLEV,INTV,INTV,DOUBLEV)
