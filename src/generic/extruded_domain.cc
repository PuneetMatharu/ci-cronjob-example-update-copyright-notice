...
namespace oomph
{
    ...
    T_max(extrusion_length)
  {
    ...
    unsigned n_macro_element=N_extruded_element*(Domain_pt->nmacro_element());
      ...
      Vector<double>& x)
  {
        ...
        (i_direct==OcTreeNames::D)||(i_direct==OcTreeNames::U))
    {
      ...
      if (i_direct==OcTreeNames::L)
      {
        ...
        Domain_pt->macro_element_boundary(t,true_macro_id,QuadTreeNames::W,
                                          s_project,x_project);
      }
      ...
      {
        // Call the corresponding function through the provided Domain object
        Domain_pt->macro_element_boundary(t,true_macro_id,QuadTreeNames::E,
                                          s_project,x_project);
      }
      ...
      {
        // Call the corresponding function through the provided Domain object
        Domain_pt->macro_element_boundary(t,true_macro_id,QuadTreeNames::S,
                                          s_project,x_project);
      }
      ...
      {
        // Call the corresponding function through the provided Domain object
        Domain_pt->macro_element_boundary(t,true_macro_id,QuadTreeNames::N,
                                          s_project,x_project);
      }
    }
    else if ((i_direct==OcTreeNames::B)||(i_direct==OcTreeNames::F))
    {
      ...
      MacroElement* macro_element_pt=Domain_pt->macro_element_pt(true_macro_id);
