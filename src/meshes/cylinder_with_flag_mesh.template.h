...
public:
 ...
 /// default timestepper.
 CylinderWithFlagMesh(Circle* cylinder_pt,
...
class RefineableCylinderWithFlagMesh :
 public CylinderWithFlagMesh<ELEMENT>, public RefineableQuadMesh<ELEMENT>
{
public: 
 ...
 RefineableCylinderWithFlagMesh(
  ...
  CylinderWithFlagMesh<ELEMENT>(cylinder_pt,
                                top_flag_pt,bottom_flag_pt,
                                tip_flag_pt,length,height,
                                flag_length,flag_height,centre_x,centre_y,
                                a,time_stepper_pt) 
  {
...
//===================================================================
template<class ELEMENT>
class AlgebraicCylinderWithFlagMesh : public AlgebraicMesh,
public virtual CylinderWithFlagMesh<ELEMENT>
{
 public :
  ...
  /// centre of the cylinder and its radius. Timestepper defaults to Steady
  /// default timestepper.
  AlgebraicCylinderWithFlagMesh(Circle* cylinder_pt,
                                GeomObject* top_flag_pt,
                                GeomObject* bottom_flag_pt,
                                GeomObject* tip_flag_pt,
                                const double &length, 
                                ...
                                TimeStepper* time_stepper_pt=
                                &Mesh::Default_TimeStepper) :
  CylinderWithFlagMesh<ELEMENT>(cylinder_pt,top_flag_pt,bottom_flag_pt,
                                tip_flag_pt,length,height,
                                flag_length,flag_height,centre_x,centre_y,
                                a,time_stepper_pt) ,
...
public:
 ...
 /// centre of the cylinder and its radius. Timestepper defaults to Steady
 /// default timestepper.
 RefineableAlgebraicCylinderWithFlagMesh(Circle* cylinder_pt,
                                         GeomObject* top_flag_pt,
                                         GeomObject* bottom_flag_pt,
                                         GeomObject* tip_flag_pt,
                                         const double &length,
  ...
  CylinderWithFlagMesh<ELEMENT>(cylinder_pt,top_flag_pt,bottom_flag_pt,
                                ...
                                flag_length,flag_height,centre_x,centre_y,
                                a,time_stepper_pt),
  AlgebraicCylinderWithFlagMesh<ELEMENT>(cylinder_pt, top_flag_pt,
                                         bottom_flag_pt,
                                         tip_flag_pt,length,height,
                                         flag_length, 
                                         flag_height, centre_x, centre_y, a,
                                         time_stepper_pt)
  {
