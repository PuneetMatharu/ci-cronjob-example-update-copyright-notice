...
namespace oomph
{
  ...
  for (unsigned e_tet=0; e_tet<n_el_tet; e_tet++)
   {
    ...
    TElement<3,3>* tet_el_pt=dynamic_cast<TElement<3,3>*>(
    ...
    //-------------------------------------------------
    {
     ...
     TFace face0(tet_el_pt->node_pt(0), 
                 tet_el_pt->node_pt(1), 
                 tet_el_pt->node_pt(2));

     TFace face1(tet_el_pt->node_pt(0), 
                 tet_el_pt->node_pt(2), 
                 tet_el_pt->node_pt(3));

     TFace face2(tet_el_pt->node_pt(0), 
                 tet_el_pt->node_pt(1), 
                 tet_el_pt->node_pt(3));
    ...
    //--------------------------------------------------
    {
     ...
     TFace face0(tet_el_pt->node_pt(1), 
                 tet_el_pt->node_pt(3), 
                 tet_el_pt->node_pt(2)); 

     TFace face1(tet_el_pt->node_pt(1), 
                 tet_el_pt->node_pt(0), 
                 tet_el_pt->node_pt(2));

     TFace face2(tet_el_pt->node_pt(1), 
                 tet_el_pt->node_pt(0), 
                 tet_el_pt->node_pt(3));
    ...
    //-------------------------------------------------
    {
     ...
     TFace face0(tet_el_pt->node_pt(3), 
                 tet_el_pt->node_pt(0), 
                 tet_el_pt->node_pt(2)); 

     TFace face1(tet_el_pt->node_pt(3), 
                 tet_el_pt->node_pt(1), 
                 tet_el_pt->node_pt(2));

     TFace face2(tet_el_pt->node_pt(3), 
                 tet_el_pt->node_pt(1), 
                 tet_el_pt->node_pt(0));
          ...
          if (tet_mesh_is_solid_mesh)
           {
            ...
            face_el_pt= 
             new DummyFaceElement<SolidTElement<3,3> >(tet_el_pt,face_index);
           }
          else
           {      
#ifdef PARANOID
            ...
            if (dist>BrickFromTetMeshHelper::Face_position_tolerance)
             {
              ...
              error_stream 
               ...
               << "following the pattern used in the ThinLayerBrickOnTetMesh."
               ...
               << "contains the coordinates of the 6 nodes in the FaceElement"
 ...
 template<class ELEMENT>
 void BrickFromTetMesh<ELEMENT>::build_mesh(
  TetgenMesh<TElement<3,3> >* tet_mesh_pt, 
  TimeStepper* time_stepper_pt)
 {
  // Mesh can only be built with 3D Qelements.
  MeshChecker::assert_geometric_element<QElementGeometricBase,ELEMENT>(3, 3);
