...
public virtual FaceGeometry<ELEMENT>, 
 ...
 PMLTimeHarmonicLinearElasticityTractionElement(FiniteElement* const &element_pt, 
 ...
 FaceGeometry<ELEMENT>(), FaceElement()
  { 
   ...
   // Zero traction
   Traction_fct_pt=
    &PMLTimeHarmonicLinearElasticityTractionElementHelper::Zero_traction_fct;
...
template<class ELEMENT>
  ...
  Vector<double> &residuals)
 {
  ...
  if(n_position_type != 1)
   {
    throw OomphLibError(
     "PMLTimeHarmonicLinearElasticity is not yet implemented for more than one position type",
     OOMPH_CURRENT_FUNCTION,
     OOMPH_EXCEPTION_LOCATION);
   }
#endif
     ...
     default:
      throw 
       OomphLibError(
        ...
        "PMLTimeHarmonicLinearElasticityTractionElement::fill_in_contribution_to_residuals()",
        OOMPH_EXCEPTION_LOCATION);
     }
